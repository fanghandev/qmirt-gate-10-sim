...
def construct_collimator_no_boolean_gate_geometry(sim: gate.Simulation, config: dict, id: int):
    ...
    collimator_body_shell = _make_shell_trd(
        sim,
    ...
    collimator_guide_shell = _make_shell_trd(
        sim,
