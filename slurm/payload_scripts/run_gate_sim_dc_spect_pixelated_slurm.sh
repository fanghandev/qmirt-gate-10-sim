#!/bin/bash
#
# run_gate_sim_dc_spect_pixelated_slurm.sh
# ==============================
...
#   sbatch-wrapper.sh -N "dc-spect" -p debug -a "0-10" -n 1 -o /scratch/f/fh890/test-ids-array -- ./run_gate_sim_dc_spect_pixelated_slurm.sh
#
